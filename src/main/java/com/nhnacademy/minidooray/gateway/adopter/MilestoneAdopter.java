...
public class MilestoneAdopter {
    ...
    public List<Milestone> getMilestones(Integer projectId){
       URI uri = getUri(String.valueOf(projectId),"/projects/{projectId}/milestones");
        ResponseEntity<List<Milestone>> response = restTemplate.exchange(uri, HttpMethod.GET,
